...
| SY6280AAC | Silergy(矽力杰) | SOT-23-5 | 2.9×1.6 | 2.7V~5.5V | 高侧负载开关/电源分配开关, 可调限流, 1.8A持续, 85mΩ RON, 过流/过热保护, 输出放电 | USB端口保护、电源轨切换、便携设备 |
...
| 型号 | 厂商 | 封装 | 封装尺寸 (mm) | 供电电压 | 关键参数 | 适用场景 |
|---|---|---|---|---|---|---|
| AD9833 | ADI(亚德诺) | MSOP-10 | 3×3 | 2.3V~5.5V | 可编程波形发生器(DDS), 28bit频率寄存器, 正弦/三角/方波输出, SPI接口, 25MHz主频 | 函数发生器、RF调制、音频合成
| HLW8110 | HLW(钜泉光电) | SOP-16 | 10.0×4.0×1.5 | 3.0V~3.6V | 单相电能计量IC, 有功/无功/视在功率, 325mV/170mV/85mV可编程增益, 5000:1动态范围, I²C/SPI接口, 精度1级/2级 | 智能电表、能源监测、电力仪表、智能插座、配电监测 |、测试仪表 |
