...
| ME4084BN8BG | Microne(南京微盟) | SOT-23-8 | 2.9×1.6×1.1 | 4.0V~6.5V | 1A线性锂电池充电器, 4.2V浮充电压, ±1%充电电压精度, 热调节保护, 充电电流可编程(外置电阻), 输入OVP, 自动再充电, 软启动 | TWS耳机充电仓、便携式设备、低功耗手持设备、单节锂电充电管理 |
