...
| TPS43060RTER | TI | WQFN-16 | 3×3 (PowerPAD) | 4.5V~38V | 同步升压控制器, 输出最高58V, 50kHz~1MHz可调, 7.5V栅极驱动, 电流模式控制 | Thunderbolt端口、汽车电源、5V/12V/24V总线电源 |
...
| TPS63020DSJR | TI | DSBGA-12 | 2.5×2.5 | 1.8V~5.5V | 升降压, 2A持续/4A峰值, 2MHz~4MHz, I²C可编程输出 | 需要I²C动态调压的电池供电设备 |
...
| AT32F425F8P7 | Cortex-M4 | TSSOP-20 | 6.5×4.4 | 120MHz | 64KB/16KB | 2V~3.6V | 小封装, USB, 基础外设 | 紧凑型控制、USB外设 |
...
| BQ24074RGRR | TI | QFN-16 | 3×3 | 4.35V~10.5V | 1.5A线性充电, 电源路径管理, USB OTG升压 | 单节锂电、空间受限的充电应用 |
...
| BQ24074RGRR | TI | QFN-16 (RGR) | 3×3 | 4.35V~10.5V | 1.5A线性充电, 电源路径管理, DPPM, 支持USB OTG升压, 28V输入 | 单节锂电、空间受限的充电应用 |
...
| TPS43060RTER | TI | WQFN-16 | 3×3 | 4.5V~38V | 同步升压控制器, 输出最高58V, 50kHz~1MHz可调, 7.5V栅极驱动 | Thunderbolt端口、汽车电源、5V/12V/24V总线 |
